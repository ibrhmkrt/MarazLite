...
extern uint8_t esikSetReceiveSecim;//Callback fonksiyonunda gönderilen transmit dönüs secimi yapabilmek icin degisken
extern uint8_t setOnayDonus;//slave adresten set isleminden sonra dönecek verinin tutulacagi degisken
extern uint8_t setOnayReturn;//mainde reset fonksiyonu cagrildiktan sonra dondurulecek degisken (1 ise set onaylandi,0 ise set onaylanmadi)
//extern uint8_t receiveDataAtsSet[1];
//extern uint8_t setOnayDonusDeneme;
...
uint8_t esikSetleme(uint8_t,uint8_t);//Mainden sayaci setlemek için kullanilan fonksiyon.0 veya 1 donderir.Argüman olarak 1 alirsa set sinyali geldigi varsayilir.
